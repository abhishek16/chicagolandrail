...
const SHELL = "mct-shell-v12";
const SHELL_ASSETS = ["./", "./index.html", "./app.js", "./app.css", "./logic.js", "./config.js", "./manifest.webmanifest", "./icons/icon192.png", "./icons/icon128.png", "./icons/icon32.png"];
